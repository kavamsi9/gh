...
<BODY  Class="SC">
<h3 align=center style="color:darkolive">Add New Location</h3>
<table align=right>
<TD><A HREF="./Accommodation0" target="RFrame"><img border="0" name="Location" src="Images/ViewLocations0.jpg" onmouseover="document['Location'].src='Images/ViewLocation1.jpg'" onmouseout="document['Location'].src='Images/ViewLocations0.jpg'" ></A></TD>
</table>

<FORM NAME="Locations" ACTION="./AddAccommodation1" OnSubmit="return validate()">
	
 <center>
 <TABLE width="30%" class="notepad">
		<TR class="row_title">
		  <TH align="center" colspan=3><FONT SIZE="4" COLOR="white" face='monotype corsiva'>Add New Location</FONT></TH>
		</TR>
		<Input type=hidden name=UserID value='<%=UserID%>'>
		<tr class=row_odd>
		  <TD align="left" width="40%"><FONT SIZE="2" COLOR="cornflowerblue" face='monotype corsiva'>Location Name </FONT><FONT COLOR="red">*</FONT></TD>
		  <TD colspan=2 align=left><Input type=text name='LocationName' value=''></TD></tr>
		  <tr class=row_even>
		  <TD align="left"><FONT SIZE="2" COLOR="white" face='monotype corsiva'>Location Image </FONT><FONT COLOR="red">*</FONT></TD>
		...
		<div id="infodiv"></div><Input type="text" name='PhotoPath' ><INPUT id="FUBtn" name="FUBtn" class= "UploadButton" TYPE="Button" value='Attach PhotoPath' onclick="fnUpload()" class="UploadButton"><br>
		  ...
		  <tr class=row_odd><TD align="left"><FONT SIZE="2" COLOR="cornflowerblue" face='monotype corsiva'>Location Description<FONT COLOR="red">*</FONT></TD>
