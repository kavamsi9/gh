...
<%
	...
	try{
		...
		%>
			<TR class= "row_even">
			<td align="left" colspan=2><B>BookingID: </B><%=BookingID%></td><td align="left" colspan=2><a href ="CancelBooking.jsp?BookingID=<%=BookingID%>&RoomID=<%=RoomID%>&From=<%=From%>&ResortID=<%=ResortID%>"><IMG SRC="Images/CancelBooking.jpg" WIDTH="147" HEIGHT="26" BORDER="0" ALT=""></a></td></tr>
